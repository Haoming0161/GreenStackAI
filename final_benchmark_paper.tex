...
GreenPyBench is the first reproducible benchmark for AI agents on Python code efficiency, with joint correctness-and-efficiency metrics, regression penalties, and a profiling harness for iterative systems. Static rule baselines confirm the benchmark requires genuine algorithmic reasoning. Full results will be reported upon completion of LLM evaluation runs. The implementation now supports both direct Anthropic access and Tinker-compatible API routing for budget-aware reproducibility. The harness, tasks, seeds, and baselines will be released to support reproducible Green AI research. Future extensions include 20 tasks, energy measurement via RAPL counters, and evaluation on real-world scientific codebases.
